...
<body>
	...
	<div class="container">
		...
		<div class="weather">
			<label for="weather">오늘의 날씨</label> <select name="weather_condition"
				id="weather">
				<optgroup label="날씨">
		...
		<div class="condition">
			<label for="condition">오늘의 컨디션</label> <select name="daily_condition"
				id="condition">
				<optgroup label="컨디션">
		...
		<div class="content">
			<textarea id="userInput" name="userInput" rows="4" cols="50">오늘을 기록하세요</textarea>
		</div>
