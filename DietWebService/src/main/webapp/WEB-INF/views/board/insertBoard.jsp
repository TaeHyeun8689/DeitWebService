			...
			<nav class="nav">
				<ul class="menu">
					<li class="item">
						...
						<li class="item">
						<a href="insertDailySport.do" class="link">
		 			...
		 			<form action="insertBoard.do" method="post" enctype="multipart/form-data">
		 				...
		 				<!--  -->
		 					<tr >
		 						...
		 						<td align="left"><textarea name="content" cols="100" rows="20"></textarea></td>
		 					</tr>
		 				<!--  -->
		 					<tr>
		 						<td bgcolor="#FAFAF5" align="center" >파일 첨부</td>
		 						<td align="left" width="30px" ><input type="file" name="uploadFile"/></td>
		 					</tr>
		 					<tr align="center">
		 						<td class="tdSubmit" align="center" colspan="2">
