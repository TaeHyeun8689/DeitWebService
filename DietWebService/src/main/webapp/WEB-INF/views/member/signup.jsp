...
<script type="text/javascript">
    $(document).ready(function () {
    	if (!$('#checkDuplicateId').prop('checked')) {
...
<body>
    <div class="main">
        ...
        <div style="margin-bottom: 10px; display: flex; align-items: center;">   
            <label for="id" class="label" style="color: #426B1F; margin-right: 20px;">회원 아이디</label>
            <input type="text" name="id" value="${member.id}" id="id">
           </div> 
            <!-- 아이디 중복확인  -->
            <input type="checkbox" name="checkDuplicateId" id="checkDuplicateId">
            <label for="checkDuplicateId" onclick="checkDuplicateId()" style="color: #426B1F; margin-left: 20px;">아이디 중복 확인</label>
            <span id="duplicateMessage" style="color: red;"></span>
        </div>
        
        <!-- 비밀번호 -->
             <div style="margin-bottom: 10px; display: flex; align-items: center; margin-right: 20px;">
